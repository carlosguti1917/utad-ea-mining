...
#loader.LoaderCalls(beginDate, endDate) # get the API calls from Elastic API e record then in MongoDB
print("LoaderCalls com sucesso")

# Data Preparation # Vale para versão final - Recupera as chamadas cruas do MongoDB e grava no MongoDB as chamadas limpas de dados do Kong que não interessam
